...
function displayFixtures(events, oddsData) {
  ...
  filtered.forEach(match => {
    ...
    let scoreInner;
    const scoreInner = isFinished
      ? `<span class="score-line"><span class="score-num" data-target="${match.intHomeScore}">0</span> - <span class="score-num" data-target="${match.intAwayScore}">0</span></span>`
      : 'vs';
